function [p_shapes, r_shape, p_num, d] = LPmake_colour_example2_C3()
% LPMAKE_COLOUR_EXAMPLE2_C3 Constructs an LP formulation of the generalized
...
%   Marcus Garvie
  ...
  filename = 'colour_example2_C3.lp';
  label = '\ LP file colour_example2_C3';
  variants_lp_write_multi(filename, label, a, b, p_num, d, num_chrom);

  % Notify user of file creation
  fprintf('\n');
  fprintf('LPmake_colour_example2_C3 created the LP file "%s"\n', filename);
