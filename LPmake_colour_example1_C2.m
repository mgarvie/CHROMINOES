function [p_shape, d, r_shape] = LPmake_colour_example1_C2()
% LPMAKE_COLOUR_EXAMPLE1_C2 Constructs an LP formulation of the generalized
% colouring equations for tiling a 120-by-120 square using 3600 copies of a 
% tetromino with two colours.
%
% Outputs:
%   p_shape - Binary matrix representing the tetromino shape.
%   d             - Vector specifying the number of copies of the polyominoes used.
...
%   Marcus Garvie
  ...
  filename = 'colour_example1_C2.lp';
  variants_lp_write_mono(filename, '\ colour_example1_C2 LP', a, b, d);

  % Notify user of file creation
  fprintf('\n');
  fprintf('LPmake_colour_example1_C2 created the LP file "%s"\n', filename);
