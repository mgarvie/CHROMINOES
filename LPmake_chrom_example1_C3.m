function [p_shapes, r_shape, p_num, d] = LPmake_chrom_example1_C3()
% LPMAKE_CHROM_EXAMPLE1_C3 Constructs an LP system for tiling a checkerboard-coloured 
...
%   (obtained from solving the LP file COLOUR_EXAMPLE1_C3 generated by 
%   LPMAKE_COLOUR_EXAMPLE1_C3) into a file named 'x.mat' in the current directory.
...
%   Marcus Garvie
  ...
  filename = 'chrom_example1_C3.lp';
  label = '\ LP file chrom_example1_C3';
  variomino_lp_write(filename, label, A, b);

  % Notify user of file creation
  fprintf('\n');
  fprintf('LPmake_chrom_example1_C3 created the LP file "%s"\n', filename);
