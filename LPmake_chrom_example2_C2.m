function [p_shapes, r_shape, p_num, d] = LPmake_chrom_example2_C2()
% LPMAKE_CHROM_EXAMPLE2_C2 Constructs an LP system for tiling a checkerboard-coloured 
...
%   (obtained from solving the LP file COLOUR_EXAMPLE2_C2 generated by 
%   LPMAKE_COLOUR_EXAMPLE2_C2) into a file named 'x.mat' in the current directory.
...
%   Marcus Garvie
  ...
  filename = 'chrom_example2_C2.lp';
  label = '\ LP file chrom_example2_C2';
  variomino_lp_write(filename, label, A, b);

  % Notify user of file creation
  fprintf('\n');
  fprintf('LPmake_chrom_example2_C2 created the LP file "%s"\n', filename);
